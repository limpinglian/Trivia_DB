...
class RecyclerViewAdapter(var countList:ArrayList<Question_Count>, val context:Context): RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.tvType_Count.text=countList[position].category
        holder.tvEasy_Count.text=countList[position].easy_count
        holder.tvMedium_Count.text=countList[position].medium_count
        holder.tvHard_Count.text=countList[position].hard_count
        holder.tvTotal_Count.text=countList[position].total_count
